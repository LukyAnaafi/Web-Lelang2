...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name='id' value="{{ $data->id }}" id="id" readonly>
        </div>
    </div>
    <div class="mb-3 row">
    ...
    <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            <label for="Lavel" class="col-sm-2 col-form-label">Lavel</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='Lavel' value="{{ $data->Lavel }}" id="Lavel">
            </div>
